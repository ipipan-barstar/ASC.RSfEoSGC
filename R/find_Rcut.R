...
if (IsPNG) png(paste0(targetDir, "/", "EigenvaluesKbased", nnn.type, ".png")); plot(LambdaV, main = "Eigenvalues K-based", ylab = "eigenvalue")
if (IsPNG) dev.off()

mEv = min(LambdaV)
cat("\nMinimal eigenvalue of K", mEv, "\n")

if (mEv < 0) { sigma = -2 * mEv + 1e-10
...
if (IsPNG) png(paste0(targetDir, "/", "EigenvaluesLbased", nnn.type, ".png")); plot(L_LambdaV, main = "Eigenvalues L-based (traditional)", col = "green3", ylab = "eigenvalue")
if (IsPNG) dev.off()
