...
if (IsPNG)
{
  if (IsMAIN)
    ...
    it = "NT"
  combPath = paste0(TARGET_DIR_PREFIX, "Results_", substr(nnn.type, 1, 3), "/", it, nnn.type, "classesComb_")
  normPath = paste0(TARGET_DIR_PREFIX, "Results_", substr(nnn.type, 1, 3), "/", it, nnn.type, "classesNorm_")
  basepath = paste0(TARGET_DIR_PREFIX, "Results_", substr(nnn.type, 1, 3))
